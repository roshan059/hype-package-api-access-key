...
<!-- <a href="https://packagist.org/packages/hypesewa/access-api-key"><img src="https://poser.pugx.org/ejarnutowski/laravel-api-key/d/total.svg" alt="Total Downloads"></a>
<a href="https://packagist.org/packages/hypesewa/access-api-key"><img src="https://poser.pugx.org/ejarnutowski/laravel-api-key/v/stable.svg" alt="Latest Stable Version"></a>
<a href="https://packagist.org/packages/hypesewa/access-api-key"><img src="https://poser.pugx.org/ejarnutowski/laravel-api-key/license.svg" alt="License"></a> -->

## Installation

Run `composer require hypesewa/access-api-key`.

In your `bootstrap/app.php` file, add the Laravel API Key service provider to the end of the `providers` array.

```php
$app->register(\Hypesewa\AccessApiKey\Providers\ApiKeyServiceProvider::class);
```
